...
set psu_mio_init_data {
    ...
    mask_write 0XFF180160 0x0043FFD7 0x0043FFD7
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x03FD710F
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFD1A0100 0x000F8044 0x00000000
		# : RESET BLOCKS
		# : TIMESTAMP
		# Register : RST_LPD_IOU2 @ 0XFF5E0238</p>
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000310
		# : DIR MODE BANK 2
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000310
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFEFF0100
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFEFF0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5 MS DELAY
